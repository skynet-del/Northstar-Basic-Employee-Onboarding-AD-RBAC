...
│
├── Incident-Reports/
│   ├── Ticket number NMG-0047.png
│   └── Ticket number NMG-0047.txt
│
├── Screenshots/
│   ├── Day-1/
│   ├── Day-2/
...
![NMG-0047 Support Ticket](Incident-Reports/Ticket%20number%20NMG-0047.png)
...
[▶ Watch the Active Directory & RBAC walkthrough on Loom](https://www.loom.com/share/63113e74a9df4afb9a4b1a01c90b7d3b)
